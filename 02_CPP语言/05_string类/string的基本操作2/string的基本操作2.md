...
| 函数名称                                                     | 作用                                                         |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| [push_back](https://cplusplus.com/reference/string/string/push_back/) | 在字符串末尾添加一个字符                                     |
| [append()](https://cplusplus.com/reference/string/string/append/) | 在字符串末尾添加一个字符串                                   |
| [operator+=](https://cplusplus.com/reference/string/string/operator+=/) | += 运算符可以插入一个字符/字符串/string对象。                |
| [resize()]()                                                 | 若 n 大于当前字符串长度：在末尾插入字符补齐至长度 n；如果指定字符 c，新增元素用 c 填充；否则使用值初始化字符（空字符 \0）。 |
...
| 函数名称                                                     | 功能说明                                                   |
| ------------------------------------------------------------ | ---------------------------------------------------------- |
| [find()](https://cplusplus.com/reference/string/string/find/) | 从字符串pos位置开始往后找字符c，返回该字符在字符串中的位置 |
| [rfind()](https://cplusplus.com/reference/string/string/rfind/) | 从字符串pos位置开始往前找字符c，返回该字符在字符串中的位置 |
| [substr()](https://cplusplus.com/reference/string/string/substr/) | 在str中从pos位置开始，截取n个字符，然后将其返回            |



### 取出文件名的后缀名

> 我有一些文件名，需要只要文件名的后缀是什么
>
> * 比如: string.c 、string.cpp、string.hpp
>
> * 可以使用find()找到"."，并使用substr截取从"."到字符串结尾的。
> * 查找到'.'的位置,把'.'后面的内容取出来。
...
> 但是我们会发现一个问题，如果文件名是: string.cpp.zip.tar 这样的。
>
> * 结果是：cpp.zip.tar
> * 而我们想要的是：tar。
> * 完善方案：从后往前查找最后一个'.'的位置,把'.'后面的内容取出来。
...
>  网址: 协议 + 域名 + 资源名称。
>
> 以： https://cplusplus.com/reference/string/string/find/ 为例子。
>
> * 协议: https
> * 域名: cplusplus.com <==> IP地址
> * 资源名称：reference/string/string/find/
...
> * 两者都能输出字符串
> * 但是cout<<字符串的首地址 ==> 遇到'\0'就结束。
> * cout << string对象 ==> 输出完string对象的size()
...
> ![截图](../assert/26.png)
>
> * 调用string重载的的operator<<，将对象数组中的所有的字符都输出。
> * 直接输出const char*，遇到\0就结束输出。
> * '\0'是不可见字符。
...
| 函数名称                                                     | 函数功能                                          |
| ------------------------------------------------------------ | ------------------------------------------------- |
| [operator+](https://cplusplus.com/reference/string/string/operator+/) | 重载了字符串的拼接操作,并返回拼接后的对象。       |
| [operator+=](https://cplusplus.com/reference/string/string/operator+=/) | 重载了字符串的拼接操作,并返回拼接后的对象的引用。 |
| [operator<<](https://cplusplus.com/reference/string/string/operator%3C%3C/) | 输出运算符重载                                    |
| [operator>>](https://cplusplus.com/reference/string/string/operator%3E%3E/) | 输入运算符重载                                    |
| [relational operators](https://cplusplus.com/reference/string/string/operators/) | 大小比较                                          |
| [getline()](https://cplusplus.com/reference/string/string/getline/) | 获取一行字符串                                    |
...
> [字符串的最后一个单词的长度](https://www.nowcoder.com/practice/8c949ea5f36f422594b306a2300315da?tpId=37&&tqId=21224&rp=5&ru=/activity/oj&qru=/ta/huawei/question-ranking)
